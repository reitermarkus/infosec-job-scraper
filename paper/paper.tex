...
The second most common requirement is an apprenticeship (Ausbildung) at around 36\%, followed by the Matura with 22\%. After a manual review of the 4\% belonging to apprenticeship (Lehre), these seem to be mostly false positives, at least in our case when only taking information security jobs into account.
...
Of the other states, only Carinthia, Styria and Upper Austria manage to pass the 5\% threshold. Tyrol and Salzburg are both at around 4\% and Lower Austria is at less than 1\% of all advertisements. Vorarlberg and Burgenland do not even have one job advertisement listed.
